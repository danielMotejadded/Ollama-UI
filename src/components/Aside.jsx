  ...
  return (
    <aside className="w-64 bg-zinc-900 p-4 text-white h-full">
      <div className="flex items-center gap-3">
        <img src={Logo} alt="brand logo skull in fire" className="w-20 h-20" />
        <div>
      ...
      <button
        ...
        className={
          " mt-6 w-full rounded bg-zinc-800 px-3 py-2 text-left hover:bg-zinc-700 disabled:opacity-50 disabled:hover:bg-zinc-800"
        }
      >
        + Utwórz nowy czat
      </button>
